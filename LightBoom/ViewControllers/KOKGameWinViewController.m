//
//  KOKGameWinViewController.m
//  LightBoom
//
//  Created by JOY CHOW on 2020/12/3.
//

#import "KOKGameWinViewController.h"
#import "KOKGameViewController.h"
#import "KOKstandardButton.h"
#import "KOKhelperMethods.h"

@interface KOKGameWinViewController ()
@property (strong, nonatomic) IBOutlet UILabel *scoreLabel;
@end

@implementation KOKGameWinViewController
...
-(void) createMyButtons
{
    ...
    // New Game Button
    button = [KOKHelperMethods createAButton: @"Play Again" at:centerStartingX and:buttonVerticalOrigin2 ofWidth: buttonWidth andHeight: buttonHeight];
