//
//  KOKInfoViewController.m
//  LightBoom
//
//  Created by JOY CHOW on 2020/12/3.
//

#import "KOKInfoViewController.h"
#import "KOKhelperMethods.h"
@interface KOKInfoViewController ()
@property UIScrollView *myScroller;
@end

@implementation KOKInfoViewController
...
- (void)viewDidLoad
{
    ...
    // Cancel
    button = [KOKHelperMethods createAButton: @" X" at:killBoxX and:killBoxY ofWidth: buttonWidth andHeight: buttonHeight];
