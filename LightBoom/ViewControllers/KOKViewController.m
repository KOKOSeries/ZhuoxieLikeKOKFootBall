...
@implementation KOKViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void) createMyButtons
{
    ...
    // New Game Button
    button = [KOKHelperMethods createAButton: @"Play" at:position2 and:tiletop+tilesize ofWidth: tilesize andHeight: tilesize];
    
    KOKStandardButton *playButton = (KOKStandardButton *) button;
...
-(void) startGame
{
  //  [self performSegueWithIdentifier: @"FirstSegue" sender: self];
    ...
    KOKViewController *game=[self.storyboard instantiateViewControllerWithIdentifier:@"GameViewController"];
