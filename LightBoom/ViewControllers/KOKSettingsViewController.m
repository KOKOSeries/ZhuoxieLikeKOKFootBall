...
@interface KOKSettingsViewController ()
...
@property (strong, nonatomic) KOKpanelBox *r1View;
@property (strong, nonatomic) UISlider *difficultySlider;
@end

@implementation KOKSettingsViewController
...
-(void) layoutTheScreen
{
    ...
    self.r1View = [[KOKpanelBox alloc] initWithFrame:rect1];
    KOKpanelBox *r2View = [[KOKpanelBox alloc] initWithFrame:rect2 andColor:dkGrayColor];
    KOKpanelBox *r3View = [[KOKpanelBox alloc] initWithFrame:rect3 andColor:dkGrayColor];
...
//    [self.view addSubview:r2View];
    ...
    self.gameColorLabel = [KOKHelperMethods createATitle:@"Game Color:" ofSize:titleLabelSize withFrame:gameColorLabelFrame];
...
//    [self.view addSubview:self.cSlider];
    ...
    self.matrixSizeLabel = [KOKHelperMethods createATitle:@"Matrix Size:" ofSize:titleLabelSize withFrame:matrixSizeLabelFrame];
//    [self.view addSubview:self.matrixSizeLabel];
    self.numberOfTilesLabel = [KOKHelperMethods createATitle:@"Number of Tiles:" ofSize:subTitleLabelSize withFrame:numberOfTilesLabelFrame];
    [self.numberOfTilesLabel setTextAlignment:NSTextAlignmentRight];
//    [self.view addSubview:self.numberOfTilesLabel];
    
    self.numberOfTilesValueLabel =[KOKHelperMethods createALabel:@"4" ofSize:valueNumberSize withFrame:numberOfTilesValueLabelFrame];
 ...
 */
    ...
    self.difficultyLabel = [KOKHelperMethods createATitle:@"Difficulty:" ofSize:titleLabelSize withFrame:difficultyLabelFrame];
    [self.view addSubview:self.difficultyLabel];
    
    self.sequenceLengthLabel = [KOKHelperMethods createATitle:@"Sequence Length:" ofSize:subTitleLabelSize withFrame:sequenceLengthLabelFrame];
    [self.sequenceLengthLabel setTextAlignment:NSTextAlignmentRight];
    [self.view addSubview:self.sequenceLengthLabel];
    
    self.sequenceLengthValueLabel = [KOKHelperMethods createALabel:@"0" ofSize:valueNumberSize withFrame:sequenceLengthValueLabelFrame];
    [self.view addSubview:self.sequenceLengthValueLabel];
    
    self.easyLabel = [KOKHelperMethods createATitle:@"easy" ofSize:tinySize withFrame:easyLabelFrame];
    [self.easyLabel setAlpha:.35];
    [self.view addSubview:self.easyLabel];
    self.hardLabel = [KOKHelperMethods createATitle:@"hard" ofSize:tinySize withFrame:hardLabelFrame];
    ...
    //
    button = [KOKHelperMethods createAButton: @"Accept" at:rightX and:buttonVerticalOrigin ofWidth: buttonWidth andHeight: buttonHeight];
    [button addTarget:self action:@selector(playButtonHit) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:button];
    
    // Cancel
    button = [KOKHelperMethods createAButton: @"Cancel" at:leftX and:buttonVerticalOrigin ofWidth: buttonWidth andHeight: buttonHeight];
